...
from configs.tinker_constraint_him import TinkerConstraintHimRoughCfg, TinkerConstraintHimRoughCfgPPO
import cv2
import os
...
def play(args):
    ...
    '/home/pi/Downloads/back_good/LocomotionWithNP3O-masteroldxgoo1/LocomotionWithNP3O-masteroldx/logs/rough_go2_constraint/Oct09_10-35-52_test_barlowtwins/model_3000.pt'))#《---------------------调用的网络模型doghome
